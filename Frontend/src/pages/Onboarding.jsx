...
export const Onboarding = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center mt-32'>
      <h2 className='gradient-title font font-extrabold text-7xl sm:text-8xl tracking-tighter'>
        I am...
      </h2>
      <div className='grid grid-cols-2 mt-16 gap-4 w-full md:px-40'>
        <Button cursor='pointer' variant='blue' className='h-36 text-2xl' onClick={() => handleRoleSelection("candidate")}>
          Candidate
        </Button>
